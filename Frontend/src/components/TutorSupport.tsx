          ...
          <div className="flex-1 w-full relative z-10">
            ...
            <ul className="mb-10 space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-700 font-medium">Choose from 38+ verified Tamil experts</span>
              </li>
            </ul>

            <Link 
              href="/tutors"
              className="mt-4 md:mt-8 inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-primary text-white hover:bg-secondary transition-all font-semibold shadow-xl shadow-primary/20 w-full sm:w-auto"
            >
              Explore Tutors
            </Link>
          </div>
