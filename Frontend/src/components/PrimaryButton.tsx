...
export default function PrimaryButton({ children, className = '', href, ...props }: PrimaryButtonProps) {
  const baseClasses = `inline-flex items-center justify-center px-6 py-3 md:px-8 md:py-4 text-base md:text-lg font-bold rounded-xl bg-primary text-white transition-all shadow-md hover:shadow-xl hover:-translate-y-0.5 hover:bg-primary-dark focus:ring-4 focus:ring-primary/20 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:hover:shadow-md ${className}`;
