            ...
            <div className="p-6 border-t border-slate-100 bg-slate-50/30 space-y-3">
              <div className="flex items-center gap-4 mb-6">
                {user.profilePhoto ? (
                  ...
                  <div className="w-12 h-12 rounded-full bg-primary/10 text-primary flex items-center justify-center border-2 border-primary/40">
                    <UserIcon size={24} />
                  </div>
                )}
                <div className="overflow-hidden">
                  <p className="text-sm font-black text-slate-900 truncate">{user.name}</p>
                  <p className="text-[10px] text-primary/70 font-bold uppercase tracking-widest truncate">{user.email}</p>
                </div>
              </div>
              <Link
                href={getProfileLink()}
                onClick={() => setIsMobileMenuOpen(false)}
                className="flex items-center gap-3 p-4 rounded-2xl bg-white border border-slate-100 hover:border-primary/20 transition-all text-xs font-bold text-slate-700 uppercase tracking-widest"
              >
              ...
              <Link
                ...
                className="flex items-center gap-3 p-4 rounded-2xl bg-white border border-slate-100 hover:border-primary/20 transition-all text-xs font-bold text-slate-700 uppercase tracking-widest"
              >
                <LayoutDashboard size={18} className="text-primary/60" />
                Dashboard
              </Link>
              <button
                onClick={() => {
                ...
                className="w-full flex items-center gap-3 p-4 rounded-2xl bg-error/5 border border-error/10 hover:bg-error/10 transition-all text-xs font-black text-error uppercase tracking-widest"
              >
                <LogOut size={18} />
                Sign Out
              </button>
