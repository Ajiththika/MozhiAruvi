        ...
        <div className="relative flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="relative group">
              <div className="h-40 w-40 rounded-3xl overflow-hidden bg-slate-100 border-4 border-white shadow-2xl ring-1 ring-border group-hover:ring-primary/30 transition-all duration-500">
                {user.profilePhoto ? (
              ...
              <div className="absolute -bottom-2 -right-2 h-8 w-8 rounded-xl bg-primary border-4 border-white shadow-lg flex items-center justify-center">
          ...
          <Button
            ...
            variant="primary"
            size="lg"
            className="bg-primary text-white hover:opacity-90 rounded-2xl px-6 shadow-lg group translate-y-[-10px]"
          >
