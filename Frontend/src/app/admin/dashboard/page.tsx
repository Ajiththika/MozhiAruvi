               ...
               <div className="rounded-[3rem] border border-indigo-100 bg-gradient-to-br from-indigo-50/40 via-white to-slate-50/30 overflow-hidden shadow-2xl shadow-indigo-200/10">
                  <div className="flex items-center justify-between border-b border-indigo-50 px-10 py-10">
                     <div className="flex items-center gap-6">
                        ...
                        <div>
                           <h3 className="text-xl font-black text-slate-800 tracking-tighter uppercase">Active Members</h3>
                           <p className="text-xs font-black text-indigo-600 uppercase tracking-[0.3em] flex items-center gap-2 mt-1">
                              ...
                              {premiumUsers.length} Subscribers
                           </p>
                        </div>
                     </div>
                     <div className="flex gap-4">
                        <div className="hidden md:flex flex-col text-right">
                           <span className="text-[10px] font-black text-primary/60 uppercase tracking-widest">Monthly Revenue</span>
                           <span className="text-xl font-black text-slate-800 tracking-tight text-indigo-600">
                              ${premiumUsers.reduce((acc, u) => {
                                 const plan = planSettings.find(p => p.plan === u.subscription?.plan);
                                 const price = u.subscription?.billingCycle === 'yearly'
                     ...
                     <table className="w-full text-left border-collapse">
                        <thead className="bg-slate-50/50 border-b border-indigo-50/60">
                           <tr>
                              ...
                              <th className="px-10 py-6 text-[10px] font-black text-indigo-700/60 uppercase tracking-widest text-right">Exp Date</th>
                           </tr>
                        </thead>
