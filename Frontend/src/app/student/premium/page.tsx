    ...
    <div className="relative min-h-screen bg-white">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 lg:py-32 space-y-24 animate-in fade-in slide-in-from-bottom-8 duration-1000">
        ...
        <div className="text-center space-y-6">
           ...
           <h1 className="text-3xl md:text-4xl lg:text-4xl font-black text-primary tracking-tight leading-[1.1] max-w-4xl mx-auto">
           ...
           <div className="flex items-center justify-center gap-8 pt-8">
              <span className={cn("text-xs font-bold uppercase tracking-widest transition-opacity", !isMonthly ? "opacity-30" : "opacity-100 text-primary")}>Monthly</span>
              <button 
              ...
              <div className="flex items-center gap-3">
                 <span className={cn("text-xs font-bold uppercase tracking-widest transition-opacity", isMonthly ? "opacity-30" : "opacity-100 text-primary")}>Yearly</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto items-stretch">
          ...
          >
             ...
             <div className="mb-12">
                ...
                <h4 className="text-3xl font-black text-primary tracking-tight uppercase">Individual {selectedTier === 'pro' ? "Explorer" : "Scholar"}</h4>
                ...
                {FEATURES.slice(0, selectedTier === 'pro' ? 7 : 8).map((feat) => (
                   <div key={feat.name} className="flex gap-4">
                      ...
                      <div className="flex flex-col">
                         <span className="text-sm font-bold text-primary tracking-tight text-left">{feat.name}</span>
                         {typeof feat[selectedTier] === 'string' && <span className="text-[10px] font-bold text-primary uppercase text-left">{feat[selectedTier]}</span>}
                      </div>
                   </div>
                ))}
             </div>
