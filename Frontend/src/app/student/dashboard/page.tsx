    ...
    <div className="space-y-12 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
           ...
           <div className="space-y-6">
              ...
              {nextLesson ? (
                ...
                <div className="flex flex-col items-center justify-center rounded-[2.5rem] border border-dashed border-slate-200 p-12 text-center bg-slate-50/50">
                    ...
                    <p className="text-base font-bold text-slate-900">No lessons started</p>
                    <p className="text-sm text-slate-500 mt-1">Explore our lessons to begin your journey!</p>
                </div>
              )}
           </div>
           ...
           <div className="space-y-6">
              ...
              {recentBlogs.length === 0 ? (
                 <div className="rounded-[2.5rem] border border-slate-100 bg-white p-12 text-center shadow-sm">
                    ...
                    <p className="text-sm font-bold text-slate-500">No stories shared yet.</p>
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {recentBlogs.map((post) => (
                       ...
                       >
                          ...
                          <p className="text-xs text-slate-500 font-medium line-clamp-2 leading-relaxed flex-1 italic">
        ...
        <div className="space-y-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between px-2">
              <h3 className="text-lg font-bold text-slate-900 tracking-tight">Engaged Events</h3>
            ...
            <div className="flex flex-col gap-4">
              {upcomingEvents.length === 0 ? (
                <div className="flex flex-col items-center justify-center rounded-[2.5rem] border border-dashed border-slate-200 p-10 text-center bg-slate-50/50">
                  ...
                  <p className="text-sm font-bold text-slate-500 mb-4">No RSVPs yet</p>
                  ...
                  return (
                    <Link key={req._id} href="/student/events" 
                      className="group flex items-center gap-4 rounded-3xl border border-slate-100 bg-white p-5 shadow-sm hover:shadow-lg transition-all"
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-0.5">
                           ...
                           <span className="text-[9px] text-slate-400 font-bold">{new Date().toLocaleDateString()}</span>
                        </div>
                      </div>
                    </Link>
                  );
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between px-2">
              <h3 className="text-lg font-bold text-slate-900 tracking-tight">My Doubts</h3>
              <Link href="/student/tutors/my-requests" className="text-sm font-bold text-primary hover:underline">View all</Link>
            </div>

            {questions.length === 0 ? (
              <div className="flex flex-col items-center justify-center rounded-[2.5rem] border border-dashed border-slate-200 p-10 text-center bg-slate-50/50 gap-3">
                ...
                {questions.map(q => {
                  ...
                  return (
                    <Link key={q._id} href="/student/tutors/my-requests" 
                      className="rounded-3xl border border-slate-100 bg-white p-5 shadow-sm flex flex-col gap-3 hover:shadow-lg transition-all"
                    >
                      <div className="flex items-start justify-between gap-2">
                        <p className="text-sm font-bold text-slate-800 line-clamp-2 flex-1 italic leading-relaxed">"{q.content}"</p>
                      ...
                      <div className="flex items-center gap-3 pt-3 border-t border-slate-50">
                         ...
                         <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">{teacherInfo?.name || "Tutor"}</p>
                      </div>
                    </Link>
                  );
                })}
          ...
          <div className="bg-slate-900 rounded-[2.5rem] p-10 text-white shadow-2xl relative overflow-hidden group">
             ...
             <div className="relative z-10 space-y-6">
                ...
                <Button href="/student/blogs/create" variant="primary" className="w-full h-14 rounded-2xl bg-primary text-white border-none hover:bg-white hover:text-slate-900 transition-colors">
                   Start a Story
                </Button>
             </div>
          </div>
