...
export default function LessonInteractiveSession() {
  ...
  if (phase === "loading") {
    return (
      <div className="flex h-screen w-full flex-col items-center justify-center bg-white dark:bg-slate-900">
        <Loader2 className="h-12 w-12 animate-spin text-mozhi-primary" />
        <p className="max-w-[80vw] mt-4 font-bold text-slate-500 text-lg">Loading lesson...</p>
      </div>
    );
  }
  ...
  if (phase === "out_of_credits") {
    return (
      <div className="flex h-screen flex-col items-center justify-center bg-white dark:bg-slate-900 px-4 text-center">
        <Zap className="h-24 w-24 text-amber-500 mb-6 drop-shadow-md" />
        <h1 className="text-3xl font-black text-slate-800 dark:text-white mb-4">Out of Energy!</h1>
  ...
  if (phase === "error") {
    return (
      <div className="flex min-h-[70vh] flex-col items-center justify-center gap-4 dark:bg-slate-900">
  ...
  if (phase === "completed") {
    return (
      <div className="flex min-h-[70vh] flex-col items-center justify-center gap-6 auto-x-scroll pt-20 pb-20 text-center animate-in fade-in zoom-in-95 duration-500 dark:bg-slate-900">
        {score?.passed ? (
  ...
  return (
    <div className="flex flex-col min-h-[85vh] animate-in fade-in duration-500 max-w-4xl mx-auto dark:bg-slate-900">
      {/* Header */}
      <div className="flex items-center justify-between border-b border-slate-200 pb-6 pt-4 dark:border-slate-800 px-4">
      ...
      {questions.length > 0 && (
        <div className="mt-12 sticky bottom-0 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 py-6 mb-6 px-4">
