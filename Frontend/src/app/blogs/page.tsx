      ...
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 md:px-8 lg:px-12 py-12 md:py-20 animate-in fade-in duration-700">
        ...
        <div className="mb-16 md:mb-24 space-y-10">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-gray-800 tracking-tight leading-tight mb-8">
              Insights into <br />
        ...
        <section id="feed" className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-20 scroll-mt-24">
          ...
          <div className="relative w-full md:max-w-sm">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-gray-100 bg-gray-50 py-4 pl-12 pr-5 text-sm font-semibold text-gray-700 outline-none transition focus:border-primary focus:ring-4 focus:ring-primary/5 placeholder:text-gray-400"
            />
          </div>
        </section>
          ...
          <div className="space-y-20">
            ...
            {featured && (
              <Link
                ...
                className="group relative flex flex-col md:flex-row gap-0 overflow-hidden rounded-[3rem] bg-white border border-gray-100 transition-all hover:shadow-2xl hover:shadow-primary/5"
              >
                <div className="w-full md:w-1/2 aspect-[16/10] md:aspect-auto bg-gray-50 relative overflow-hidden">
                  ...
                  <div className="absolute top-8 left-8">
                     <span className="rounded-full bg-white px-5 py-2 text-xs font-bold text-white tracking-tight">
                        Featured Story
                     </span>
                  </div>
                </div>
                ...
                <div className="flex flex-col justify-center p-10 md:p-14 md:w-1/2 space-y-8">
                  <div className="space-y-4">
                    ...
                    <h2 className="text-3xl md:text-5xl font-bold text-gray-800 group-hover:text-primary transition-colors leading-[1.1] tracking-tight">
                      {featured.title}
                    </h2>
                    <p className="text-lg text-gray-600 line-clamp-3 leading-relaxed font-medium">
                  ...
                  <div className="flex items-center justify-between pt-8 border-t border-slate-50 mt-auto">
                    <div className="flex items-center gap-4">
                      <div className="h-12 w-12 rounded-full bg-gray-100 flex items-center justify-center border border-gray-100 shadow-sm">
                    ...
                    <ArrowRight className="h-6 w-6 text-gray-300 group-hover:text-primary group-hover:translate-x-2 transition-all" />
                  </div>
                </div>
              </Link>
            )}
              ...
              {rest.map((post) => {
                ...
                return (
                  <div key={post._id} className="group relative flex flex-col h-full animate-in fade-in slide-in-from-bottom-2 duration-500">
                    ...
                    >
                      <div className="aspect-[1.6/1] w-full bg-gray-50 rounded-[2.5rem] relative overflow-hidden mb-6 border border-gray-100 transition-all group-hover:shadow-2xl shadow-slate-200/20">
                        {post.featuredImage ? (
                        ...
                        <div className="absolute top-4 left-4 flex gap-2">
                           {post.status === 'draft' && (
                              <span className="rounded-full bg-white/90 backdrop-blur px-3 py-1.5 text-[10px] font-bold text-gray-600 shadow-sm border border-gray-100">
                                Draft
                              </span>
                           )}
                           <span className="rounded-full bg-gray-100 backdrop-blur-md px-3 py-1.5 text-[10px] font-bold text-gray-700 border border-black/5">
                      ...
                      <div className="flex flex-1 flex-col space-y-4">
                        <h4 className="text-xl font-bold text-gray-800 group-hover:text-primary transition-colors line-clamp-2 leading-tight tracking-tight">
                          {post.title}
                        </h4>
                        <p className="text-gray-600 text-sm leading-relaxed line-clamp-2 flex-1 font-medium">
                    ...
                    <div className="flex items-center justify-between mt-6 pt-6 border-t border-slate-50">
                       <button
                        ...
                        className="flex items-center gap-2 text-[11px] font-bold text-gray-400 hover:text-primary transition-all tracking-tight"
                       >
                       ...
                       {isOwner && (
                         <div className="flex items-center gap-6">
                           <Link
                             ...
                             className="flex items-center gap-1.5 text-[11px] font-bold text-gray-400 hover:text-secondary transition-all tracking-tight"
                           >
