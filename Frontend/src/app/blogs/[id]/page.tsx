    ...
    <div className="min-h-screen flex flex-col font-sans bg-white">
      ...
      <main className="flex-1 w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16 animate-in fade-in duration-700">
        ...
        <article className="max-w-4xl mx-auto mb-20">
          ...
          <div
            className="prose prose-slate lg:prose-xl max-w-none text-gray-700 leading-relaxed font-medium selection:bg-primary/20 [&_h1]:text-4xl [&_h1]:font-black [&_h1]:tracking-tight [&_h1]:mt-8 [&_h1]:mb-4 [&_h2]:text-3xl [&_h2]:font-bold [&_h2]:tracking-tight [&_h2]:mt-8 [&_h2]:mb-3 [&_h3]:text-2xl [&_h3]:font-bold [&_h3]:mt-6 [&_h3]:mb-3 [&_blockquote]:border-l-4 [&_blockquote]:border-primary/30 [&_blockquote]:pl-6 [&_blockquote]:italic [&_blockquote]:text-gray-500 [&_blockquote]:my-6 [&_pre]:bg-gray-50 [&_pre]:border [&_pre]:border-gray-100 [&_pre]:rounded-2xl [&_pre]:p-6 [&_pre]:my-6 [&_code]:font-mono [&_code]:text-primary [&_code]:bg-primary/5 [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded [&_ul]:pl-8 [&_ul]:list-disc [&_ul]:space-y-2 [&_ol]:pl-8 [&_ol]:list-decimal [&_ol]:space-y-2 [&_p]:mb-4 [&_p]:leading-[1.85] [&_strong]:font-black"
