...
export default function TutorProfileSettings() {
  ...
  if (authLoading) return (
    <div className="flex flex-col items-center justify-center min-h-[400px] gap-3">
      ...
      <p className="text-gray-500 font-bold uppercase tracking-widest text-[10px]">Accessing Mentor Profile...</p>
    </div>
  );
  ...
  if (!user) return (
     <div className="p-8 text-center flex flex-col items-center gap-4">
        ...
        <p className="text-gray-600 font-bold">Authentication mismatch.</p>
              ...
              <div className="flex items-center justify-center md:justify-start gap-4 pt-2">
                 <button
                    ...
                    className={cn(
                       ...
                       user.isTutorAvailable ? "bg-emerald-50 text-emerald-700 border-emerald-200" : "bg-gray-100 text-gray-500 border-gray-200"
                    )}
                 >
                    <div className={cn("h-2 w-2 rounded-full", user.isTutorAvailable ? "bg-emerald-500 animate-pulse" : "bg-gray-400")} />
              ...
              <div className="space-y-5">
                 <div className="flex items-center gap-4">
                    ...
                    <div>
                       ...
                       <p className="text-sm font-bold text-gray-800">{user.specialization || "General Mentor"}</p>
                    </div>
                 </div>
                 <div className="flex items-center gap-4">
                    ...
                    <div>
                       ...
                       <p className="text-sm font-bold text-gray-800">{user.experience || "Native Speaker"}</p>
                    </div>
                 </div>
                 <div className="flex items-center gap-4">
                    ...
                    <div>
                       ...
                       <p className="text-sm font-bold text-gray-800">~24 hrs</p>
                    </div>
                 </div>
              </div>
           </div>
        ...
        <div className="lg:col-span-2 space-y-8">
           <div className="rounded-2xl bg-white p-10 border border-border shadow-sm min-h-[400px]">
              <div className="flex items-center gap-4 mb-8">
                ...
                <h3 className="text-2xl font-black tracking-tight text-gray-900">Academic & Teaching Bio</h3>
              </div>
              ...
              <div className="space-y-8">
                 ...
                 <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="p-4 rounded-3xl border border-border/60 bg-white text-center">
                        <p className="text-[8px] font-black text-gray-400 uppercase tracking-widest mb-1">Country</p>
                        <p className="text-xs font-black text-gray-800 truncate">{user.country || "Earth"}</p>
                    </div>
                    <div className="p-4 rounded-3xl border border-border/60 bg-white text-center">
                        <p className="text-[8px] font-black text-gray-400 uppercase tracking-widest mb-1">Age</p>
                        <p className="text-xs font-black text-gray-800">{user.age || "N/A"}</p>
                    </div>
                    <div className="p-4 rounded-3xl border border-border/60 bg-white text-center">
                        <p className="text-[8px] font-black text-gray-400 uppercase tracking-widest mb-1">Gender</p>
                        <p className="text-xs font-black text-gray-800 capitalize">{user.gender || "Any"}</p>
                    </div>
                    <div className="p-4 rounded-3xl border border-border/60 bg-white text-center">
                        <p className="text-[8px] font-black text-gray-400 uppercase tracking-widest mb-1">Joined</p>
                        <p className="text-xs font-black text-gray-800">{new Date(user.createdAt || "").toLocaleDateString("en-GB", { month: 'short', year: 'numeric' })}</p>
                    </div>
                 </div>
              </div>
           </div>
           ...
           <div className="w-full max-w-4xl bg-white rounded-2xl shadow-2xl border border-border overflow-hidden animate-in zoom-in-95 duration-500">
              <div className="flex items-center justify-between p-8 border-b border-border bg-surface-soft/30">
                 <div className="flex items-center gap-4">
                    ...
                    <div>
                       <h3 className="text-xl font-black text-gray-900 tracking-tight">Professional Configuration</h3>
                       <p className="text-[10px] font-black uppercase tracking-widest text-gray-400">Calibrate your mentor identity</p>
                    </div>
                 </div>
              ...
              <form onSubmit={handleSubmit} className="p-10 space-y-8 max-h-[75vh] overflow-y-auto scrollbar-hide">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div className="space-y-2">
                       <label className="text-[10px] font-black uppercase tracking-widest text-gray-500 ml-1">Mentor Name</label>
                       <input name="name" value={formData.name} onChange={handleChange} required className="w-full h-14 rounded-2xl bg-surface-soft border border-border px-6 text-sm font-bold text-gray-800 focus:bg-white focus:border-secondary transition-all outline-none" />
                    </div>
                    <div className="space-y-2">
                       <label className="text-[10px] font-black uppercase tracking-widest text-gray-500 ml-1">Specialization</label>
                       <input name="specialization" value={formData.specialization} onChange={handleChange} placeholder="e.g. Tamil Grammar" className="w-full h-14 rounded-2xl bg-surface-soft border border-border px-6 text-sm font-bold text-gray-800 focus:bg-white focus:border-secondary transition-all outline-none" />
                    </div>
                    <div className="space-y-2">
                       <label className="text-[10px] font-black uppercase tracking-widest text-gray-500 ml-1">Experience Years</label>
                       <input name="experience" value={formData.experience} onChange={handleChange} placeholder="e.g. 5+ Years" className="w-full h-14 rounded-2xl bg-surface-soft border border-border px-6 text-sm font-bold text-gray-800 focus:bg-white focus:border-secondary transition-all outline-none" />
                    </div>
                    <div className="space-y-2">
                       <label className="text-[10px] font-black uppercase tracking-widest text-gray-500 ml-1">Hourly Rate (XP)</label>
                       <input type="number" name="hourlyRate" value={formData.hourlyRate} onChange={handleChange} className="w-full h-14 rounded-2xl bg-surface-soft border border-border px-6 text-sm font-bold text-gray-800 focus:bg-white focus:border-emerald-500 transition-all outline-none" />
                    </div>
                    <div className="space-y-2">
                       <label className="text-[10px] font-black uppercase tracking-widest text-gray-500 ml-1">Contact Phone</label>
                       <input name="phoneNumber" value={formData.phoneNumber} onChange={handleChange} className="w-full h-14 rounded-2xl bg-surface-soft border border-border px-6 text-sm font-bold text-gray-800 focus:bg-white focus:border-secondary transition-all outline-none" />
                    </div>
                    <div className="space-y-2">
                       <label className="text-[10px] font-black uppercase tracking-widest text-gray-500 ml-1">Operation Country</label>
                       <input name="country" value={formData.country} onChange={handleChange} className="w-full h-14 rounded-2xl bg-surface-soft border border-border px-6 text-sm font-bold text-gray-800 focus:bg-white focus:border-secondary transition-all outline-none" />
                    </div>
                 </div>

                 <div className="space-y-2">
                    <label className="text-[10px] font-black uppercase tracking-widest text-gray-500 ml-1">Professional Bio</label>
                    <textarea name="bio" rows={4} value={formData.bio} onChange={handleChange} className="w-full rounded-3xl bg-surface-soft border border-border p-6 text-sm font-medium text-gray-700 focus:bg-white focus:border-secondary transition-all outline-none resize-none" />
                 </div>
