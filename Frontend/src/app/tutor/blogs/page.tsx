      ...
      <div className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-10 pb-12 border-b border-border">
        <div className="space-y-6">
           <div className="flex items-center gap-3">
              ...
              <span className="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Portfolio Management</span>
           </div>
           <h1 className="text-5xl font-black text-gray-900 tracking-tighter leading-none">Creative Archives</h1>
           <p className="text-gray-400 font-bold max-w-lg tracking-tight">Manage your contributions to the community library and track your thought leadership.</p>
        </div>
        ...
        <div className="flex items-center gap-6">
          <div className="relative group hidden lg:block">
            ...
            <input
              ...
              className="w-80 h-14 rounded-2xl border border-border bg-white px-12 text-sm font-bold text-gray-800 outline-none transition focus:border-primary focus:ring-4 focus:ring-primary/5 placeholder:text-gray-300"
            />
          </div>
          <Button
            href="/blogs/write"
      ...
      {!loading && filtered.length === 0 && (
        <div className="bg-white rounded-[3rem] border border-border p-24 text-center space-y-8 shadow-sm">
          ...
          <div className="space-y-3">
            <h3 className="text-2xl font-black text-gray-900 tracking-tight">Your repository is empty</h3>
            <p className="text-gray-400 font-bold max-w-xs mx-auto">Start sharing your linguistic expertise and heritage stories today.</p>
          </div>
            ...
            return (
              <div key={blog._id} className="group relative flex flex-col h-full bg-white rounded-[3rem] border border-border overflow-hidden transition-all hover:shadow-[0_32px_64px_-16px_rgba(0,0,0,0.08)]">
                ...
                <div className="flex flex-col flex-1 p-10 space-y-6">
                  ...
                  <h3 className="text-2xl font-black text-gray-900 group-hover:text-primary transition-colors line-clamp-2 leading-tight tracking-tighter">
                    {blog.title}
                  </h3>
                  <p className="text-gray-400 text-sm font-bold line-clamp-2 tracking-tight leading-relaxed flex-1">
                  ...
                  <div className="flex items-center justify-between pt-8 border-t border-border mt-auto">
                    ...
                    <Link
                      ...
                      target="_blank"
                      className="h-10 w-10 rounded-full bg-surface-soft border border-border flex items-center justify-center text-gray-400 hover:bg-gray-900 hover:text-white transition-all shadow-sm"
                    >
