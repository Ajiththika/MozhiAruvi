  ...
  return (
    <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500">
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
         {/* Main Settings Panel */}
         <div className="flex flex-col rounded-2xl border border-gray-100 bg-white p-6 shadow-sm dark:border-gray-100 dark:bg-gray-50 lg:col-span-2">
            <div className="mb-6 flex items-center justify-between border-b border-gray-100 pb-4 dark:border-gray-100">
                <h3 className="text-lg font-semibold text-gray-600 dark:text-gray-600">Weekly Hours</h3>
                <div className="flex items-center gap-2">
                   <button className="flex items-center gap-1.5 rounded-lg border border-gray-100 bg-gray-50 px-3 py-1.5 text-xs font-medium text-gray-600 dark:border-gray-100 dark:bg-gray-50 dark:text-gray-600">
            ...
            <div className="flex flex-col space-y-4">
               {WEEK_DAYS.map((day, index) => (
                  <div key={day} className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-6 border-b border-gray-100 pb-4 last:border-0 last:pb-0 dark:border-gray-100">
         ...
         <div className="flex flex-col rounded-2xl border border-gray-100 bg-white p-6 shadow-sm dark:border-gray-100 dark:bg-gray-50 min-h-[400px]">
            <div className="mb-4 flex items-center justify-between border-b border-gray-100 pb-4 dark:border-gray-100">
               <h3 className="font-bold text-gray-600 dark:text-gray-600">Preview</h3>
               <div className="flex gap-1">
                  <button className="rounded p-1 text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-50"><ChevronLeft className="h-4 w-4" /></button>
                  <button className="rounded p-1 text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-50"><ChevronRight className="h-4 w-4" /></button>
               </div>
            </div>

            <div className="flex flex-1 items-center justify-center rounded-xl bg-gray-50 border border-gray-100 border-dashed dark:border-gray-100">
               <div className="text-center p-6 text-gray-600 dark:text-gray-600">
