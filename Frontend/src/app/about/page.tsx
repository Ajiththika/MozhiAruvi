                  ...
                  <div className="bg-white rounded-3xl border border-border-color shadow-2xl p-8 relative z-10">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-4 p-4 bg-soft-bg rounded-xl border border-border-color">
                        ...
                        <div>
                          <p className="font-bold text-accent-text text-sm">Lesson 1 — Tamil Alphabet</p>
                      ...
                      <div className="flex items-center gap-4 p-4 bg-soft-bg rounded-xl border border-border-color">
                        ...
                        <div>
                          <p className="font-bold text-accent-text text-sm">Pronunciation Practice</p>
                          <div className="h-1.5 bg-border-color rounded-full mt-2 w-full overflow-hidden">
                      ...
                      <div className="flex items-center gap-4 p-4 bg-soft-bg rounded-xl border border-border-color">
                        ...
                        <div>
                          <p className="font-bold text-accent-text text-sm">Quiz — Basic Greetings</p>
                          <div className="h-1.5 bg-border-color rounded-full mt-2 w-full overflow-hidden">
                    ...
                    <div className="mt-6 flex items-center justify-between px-2">
                      <p className="text-muted text-sm font-medium">Your Progress</p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {featureCards.map((card) => (
                <div
                  key={card.title}
                  className="bg-white rounded-2xl p-8 border border-border-color hover:border-primary/30 hover:shadow-lg transition-all duration-300 group"
                >
